  ...
  render() {
    ...
    return (
      <Paper className={classes.paper}>
        <form onSubmit={this.grabPopcorn.bind(this, this.state.year)} className={classes.form}>
          <FormControl required fullWidth>
            ...
            >
              {this.arr.map(year => <MenuItem value={year}>{year}</MenuItem> )}
            </Select>
          </FormControl>
          <Button
